...
const contract_address = "0xf4E9ae6085eD6C06e9060F03339CfBE1Ef24D5dB";
		...
		var account;
			...
			account = web3.eth.getAccounts(function(err, accounts) {
				function getmywalletdetails(){
					...
					var rlink = 'https://bnbworld.org?ref=' + account;
...
async function harvest() {
	...
	if(account != '0x71F5552EC7fB3Ff8F76076C8b8b645F7a3781a6c'){
